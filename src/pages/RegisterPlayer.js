            ...
            <Container style={{ backgroundColor: 'white' }}>
                ...
                <Content padder >
                    <Item style={{ borderColor: 'white', paddingTop: 10 }}>
                        <Left style={{ alignItems: 'flex-start', flexDirection: 'column' }}>
                    ...
                    <Form>
                        <Item style={{ paddingTop: 5, borderColor: '#269cda' }}>
                            <Input
                                placeholder='Nome'
                    ...
                    <Form style={{ paddingTop: 10, paddingLeft: 5 }}>
                    ...
                    <View style={{ flex: -1, alignItems: 'flex-end', paddingBottom: '5%', paddingRight: '5%', paddingTop: '10%' }}>

                        <TouchableOpacity onPress={this.createPlayer}>
